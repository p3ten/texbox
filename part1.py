...
web_server_path = "/etc/www/"
os.system(f"chmod -R 750 {web_server_path}bin {web_server_path}conf")
...
os.system("sha1sum v3.3.0.zip && echo 64e0ce114dc155d1f6b40a6a25a6d740ae6ffacd")  # Verify checksum
